    ...
    try{
      ...
      if(co?.whatsapp_invoices&&co?.meta_phone_id&&co?.meta_token){
        ...
        if(phone.length>=10){
          ...
          const portalUrl=`${co?.portal_url||window.location.origin}/?invoice=${ns.id}`;
        }
      }
    }catch(e){showToast(e.message,"error");}
    setSaving(false);
    ...
    <div className="app">
      ...
      <div style={{display:"flex",minHeight:"100vh"}}>
        ...
        <div className="no-print" style={{width:222,background:"#ebebeb",borderRight:"1px solid #d1d5db",display:"flex",flexDirection:"column",padding:"0 8px",flexShrink:0,overflowY:"auto",height:"100vh",position:"sticky",top:0}}>
          ...
          <button className="btn bgh" style={{width:"100%",justifyContent:"center",margin:"8px 0 14px",fontSize:11}} onClick={handleLogout}>{ic.logout} Sign Out</button>
        </div>
            ...
            <div style={{maxWidth:540}}>
              <div className="card" style={{padding:22,marginBottom:14}}>
                ...
                {coEdit&&<div style={{display:"flex",flexDirection:"column",gap:11}}>
                  {[{l:"Company Name",k:"name"},{l:"Address",k:"address"},{l:"Phone",k:"phone"},{l:"Email",k:"email"},{l:`Default Tax Rate (%)`,k:"tax_rate"},{l:"Customer Portal URL (included in WhatsApp invoice links)",k:"portal_url"},{l:"Stripe Payment Link (for driver card QR)",k:"stripe_payment_link"}].map(f=>(
